    ...
    try {
      ...
      if (res.ok) {
        toast({
          ...
          description: `Mata pelajaran ${subjectName} beserta seluruh modul dan soalnya telah dihapus.`,
        });
      } else {
        toast({
          title: "Gagal menghapus",
          description: res.error || "Terjadi kesalahan saat menghapus mata pelajaran.",
          variant: "destructive",
        });
      }
    } catch (err) {
      ...
      <AlertDialogContent onClick={(e) => e.stopPropagation()}>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            Tindakan ini tidak dapat dibatalkan dan akan menghapus <strong>semua modul dan soal</strong> yang terkait dengan mata pelajaran ini di semua kelas.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
